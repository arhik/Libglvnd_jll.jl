...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Libglvnd_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("7e76a0d4-f3c7-5321-8279-8d96eeed0f29"))
...
if best_platform === nothing
    @debug("Unable to load Libglvnd; unsupported platform $(triplet(platform_key_abi()))")
else
