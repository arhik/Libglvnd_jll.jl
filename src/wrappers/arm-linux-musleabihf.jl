# Autogenerated wrapper script for Libglvnd_jll for arm-linux-musleabihf
export libGLX, libGL, libEGL, libOpenGL, libGLESv2, libGLdispatch, libGLESv1_CM
...
function __init__()
    ...
    foreach(p -> append!(PATH_list, p), (Xorg_libX11_jll.PATH_list, Xorg_libXext_jll.PATH_list, Xorg_glproto_jll.PATH_list,))
    foreach(p -> append!(LIBPATH_list, p), (Xorg_libX11_jll.LIBPATH_list, Xorg_libXext_jll.LIBPATH_list, Xorg_glproto_jll.LIBPATH_list,))
